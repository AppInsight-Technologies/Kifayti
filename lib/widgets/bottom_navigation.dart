           ...
           //                ),
                          Expanded(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                //color: ColorCodes.cyanColor,
                                color: Features.ismultivendor?ColorCodes.greenColor:Colors.green,
                                borderRadius: BorderRadius.circular(10),
                              ),
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.start,
                                children: <Widget>[
                                  Image.asset(
                                    Images.bag, height: 30, width: 30, color: IConstants.isEnterprise && Features.ismultivendor?ColorCodes.whiteColor:IConstants.isEnterprise? ColorCodes.whiteColor:ColorCodes.whiteColor,
                                  ),
                                  SizedBox(width: 5,),
                                  (_calculation.getTotal() == "0")? Text(_calculation.getItemCount(),  style: TextStyle(
                                    fontSize: 15,
                                    ...
                                    children: [
                                      Text(_calculation.getItemCount(),  style: TextStyle(
                                        fontSize: 15,
                                        color: IConstants.isEnterprise && Features.ismultivendor?ColorCodes.whiteColor:IConstants.isEnterprise? ColorCodes.whiteColor:ColorCodes.whiteColor,
                                        fontWeight: FontWeight.w700,
                                      ),
                                      ),
                                      SizedBox(height: 3,),
                                  ...
                                  Icon(Icons.keyboard_arrow_right_sharp, size: 35, color: IConstants.isEnterprise && Features.ismultivendor?ColorCodes.whiteColor:IConstants.isEnterprise? ColorCodes.whiteColor:ColorCodes.whiteColor,),
                                ],
                              ),
                            ),
                          )
           ...
           //            ),
                      Expanded(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            //color: ColorCodes.cyanColor,
                            color: Features.ismultivendor?/*ColorCodes.greenColor:ColorCodes.greenColor*/Colors.green:Colors.green,
                            borderRadius: BorderRadius.circular(10),
                          ),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.start,
