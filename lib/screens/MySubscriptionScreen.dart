                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (_, j) {
                      return UpcomingSubscriptionDisplay(
                        subscriptiondate[i].date!,
                        subscriptiondate[i].data![j].subOrderId!,
                        subscriptiondate[i].data![j].id!,
                        ...
                        subscriptiondate[i].data![j].type == "1"?
                        subscriptiondate[i].data![j].weight!:
                        subscriptiondate[i].data![j].priceVariation![0].weight!,
                        subscriptiondate[i].data![j].type == "1"?
                        subscriptiondate[i].data![j].id!:
                        subscriptiondate[i].data![j].priceVariation![0].id!,
