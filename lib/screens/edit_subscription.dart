...
class _EditSubscriptionState extends State<EditSubscription> with Navigations{
  ...
  _dialogforProcessing(BuildContext context) {
    return showDialog(
        context: context,
        builder: (context) {
  ...
  Future<void> EditSubscription() async {
    var resBody = {};
    resBody["item_id"] = isselect == -1 ?widget.itemid.toString():_itemid.toString();
    resBody["varId"] = isselect == -1?widget.varid.toString():_varid.toString();
    resBody["mrp"] = isselect == -1?widget.mrp.toString():_mrpedit.toString();
    resBody["price"] = isselect == -1?widget.price.toString():_priceedit.toString();
    resBody["subOrderId"] = widget.suborderid.toString() ;
    resBody["quantity"] = isselect == -1?_itemCount.toString():_count.toString();
    resBody["weight"] = isselect == -1?widget.weight.toString():_weight.toString();

print("res bosy edit......."+resBody.toString());
    final response = await http.post(Api.editSubscription, /*headers: {
    ...
    if (responseJson['status'] == 200) {
      ...
      Fluttertoast.showToast(
          msg: S.of(context).updated_success,
                                              ...
                                              children: [
                                                ...
                                                GestureDetector(
                                                  ...
                                                  onTap: (){
                                                    print("min itemm1111....."+widget.maxitem.toString() +"min item////"+widget.minitem.toString() + "cpount...."+_itemCount.toString());
                                                    setState(() {
                                                      if(productsdata[index].stock!>0) {
                                                        if (_count <=
                                                            productsdata[index].minItem!) {
                                                          isselect = -1;
                                                          // Fluttertoast.showToast(
                                                          //     msg:
                                                          //     S.of(context).cant_add_more_item, //"Sorry, you can\'t add more of this item!",
                                                        ...
                                                        Fluttertoast.showToast(
                                                            msg:
                                                            S.of(context).out_of_stock, //"Sorry, you can\'t add more of this item!",
                                                            fontSize: MediaQuery.of(context).textScaleFactor * 13,
                                                            backgroundColor: Colors.black87,
                                                            textColor: Colors.white);
                                                      }
                                                ...
                                                GestureDetector(
                                                  ...
                                                  onTap: (){
                                                    setState(() {
                                                      print("min itemm....."+productsdata[index].maxItem!.toString()+"min item////"+productsdata[index].minItem!.toString());
                                                      if(productsdata[index].stock!>0) {
                                                        if (_count >= productsdata[index]
                                                                .maxItem!) {
                                                          Fluttertoast.showToast(
                                                              msg:
                                                              S
                                              ...
                                              onTap: (){
                                                setState(() {
                                                  ...
                                                  if(isselect == index){
                                                    ...
                                                    isselect= index;
                                                    _count = 1;
                                                    _itemid = productsdata[index].id!;
                                                    if(productsdata[index].type == "1"){
                                                      _varid = productsdata[index].id!;
                                                      _weight = productsdata[index].weight!;

                                                    }
                                                    else{
                                                      _varid = productsdata[index].priceVariation![0].id!;
                                                      _weight = productsdata[index].priceVariation![0].weight!;
                                                    }

                                                    if(_checkmembership) { //Membered user
                                                      if(productsdata[index].type == "1") {  //SingleSku item
                                                        if (productsdata[index].membershipDisplay!) { //Eligible to display membership price
                                                          _priceedit = productsdata[index].membershipPrice!.toString();
                                                          _mrpedit = productsdata[index].mrp!.toString();
                                                        } else if (productsdata[index].discointDisplay!) { //Eligible to display discounted price
                                                          _priceedit = productsdata[index].price!.toString();
                                                          _mrpedit = productsdata[index].mrp!.toString();
                                                        } else { //Otherwise display mrp
                                                          _priceedit = productsdata[index].mrp!.toString();
                                                        }
                                                      }
                                                      else{ //multisku
                                                        if (productsdata[index].priceVariation![0]
                                                            .membershipDisplay!) { //Eligible to display membership price
                                                          _priceedit = productsdata[index].priceVariation![0].membershipPrice!.toString();
                                                          _mrpedit = productsdata[index].priceVariation![0].mrp!.toString();
                                                        } else if (productsdata[index].priceVariation![0]
                                                            .discointDisplay!) { //Eligible to display discounted price
                                                          _priceedit = productsdata[index].priceVariation![0].price!.toString();
                                                          _mrpedit = productsdata[index].priceVariation![0].mrp!.toString();
                                                        } else { //Otherwise display mrp
                                                          _priceedit = productsdata[index].priceVariation![0].mrp!.toString();
                                                        }
                                                      }
                                                    } else { //Non membered user
                                                      print("data product mrp....1"+productsdata[index].type.toString()+ "nanme...."+productsdata[index].itemName.toString());
                                              ...
                                              children: [
                                                ...
                                                GestureDetector(
                                                  ...
                                                  onTap: (){
                                                    print("min itemm1111....."+widget.maxitem.toString() +"min item////"+widget.minitem.toString() + "cpount...."+_itemCount.toString());
                                                    setState(() {
                                                      if(productsdata[index].priceVariation![0].stock!>0) {
                                                        if (_count <= int.parse(
                                                            productsdata[index]
                                                                .priceVariation![0]
                                                                .minItem!)) {
