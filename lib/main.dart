...
Future<void> main() async {
  ...
  if(!PrefUtils.prefs!.containsKey("branch"))
    PrefUtils.prefs!.setString("branch", "66");
            ...
            builder: (BuildContext context, store, VxStatus? status) {
              return  MaterialApp.router(
                ...
                theme: ThemeData(
                  ...
                  pageTransitionsTheme: NoTransitionsOnWeb(), colorScheme: ColorScheme.fromSwatch(primarySwatch: MaterialColor(0xff7C4B9B, {
                    50: Color(0xff7C4B9B),
                  ...
                  })).copyWith(secondary: MaterialColor(0xff7C4B9B, {
                    50: Color(0xff7C4B9B),
                    100: Color(0xff7C4B9B),
                    200: Color(0xff7C4B9B),
                    300: Color(0xff7C4B9B),
